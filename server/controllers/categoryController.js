...
const createCategory = asyncHandler(async (req, res) => {
  ...
  // 1. FIRST - Log the entire request body
  console.log("=== CREATE CATEGORY DEBUG ===");
  console.log("Request body:", JSON.stringify(req.body, null, 2));
  console.log("Category Type value:", req.body.categoryType);
  console.log("Category Type type:", typeof req.body.categoryType);
  ...
  console.log("=== CREATE CATEGORY DEBUG ===", categoryExists);
  ...
  if (image) {
    ...
    console.log("=== CREATE CATEGORY DEBUG ===", imageUrl);
  }
